...
export function initializeMockData(): void {
  ...
  const mockRequests: EngineRequest[] = [
    ...
    },
    {
      id: "PRC-2026-0001",
      module: "purchase",
      title: "Office supplies from Amazon",
      status: "in_customs",
      requesterId: "USR-001",
      requesterName: "Marwan Elafifi",
      requesterEmail: "marwan.elafifi@si-ware.com",
      payload: {
        itemTitle: "Desk Lamps & Accessories",
        ...
        businessJustification: "Regular office supply replenishment",
      },
      statusHistory: [
    ...
    },
    {
      id: "PRC-2026-0003",
      module: "purchase",
      title: "Ergonomic chairs from Noon",
      status: "new",
      requesterId: "USR-001",
      requesterName: "Marwan Elafifi",
      requesterEmail: "marwan.elafifi@si-ware.com",
      payload: { itemTitle: "Ergonomic Office Chairs", description: "10 ergonomic chairs for the engineering floor", category: "Furniture", platform: "Noon", quantity: 10, estimatedPrice: 8500, supplier: "Noon", department: "Engineering", businessJustification: "Improve workplace comfort and productivity" },
      statusHistory: [
        { status: "new", changedBy: "USR-001", changedAt: new Date(now.getTime() - 1 * 24 * 60 * 60 * 1000).toISOString(), comment: "Submitted" },
      ],
      commentHistory: [],
    ...
    },
    {
      id: "PRC-2026-0004",
      module: "purchase",
      title: "Software licenses from vendor",
      status: "delivered",
      requesterId: "USR-001",
      requesterName: "Marwan Elafifi",
      requesterEmail: "marwan.elafifi@si-ware.com",
      payload: { itemTitle: "JetBrains & Figma Licenses", description: "Jetbrains & Figma annual licenses renewal", category: "Software", platform: "Other", supplier: "JetBrains", quantity: 25, estimatedPrice: 12000, department: "Engineering", businessJustification: "Development tools and design software for team" },
      statusHistory: [
