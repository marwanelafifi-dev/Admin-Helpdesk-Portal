...
export async function PUT(req: Request) {
  ...
  const next: CompanyDataShape = {
    ...
    travel_expense_descriptions: Array.isArray(body.travel_expense_descriptions) ? body.travel_expense_descriptions : [],
  ...
  const LABELS: Record<keyof CompanyDataShape, string> = {
    ...
    travel_expense_descriptions: "Travel Expense Descriptions",
    carriers:            "Carriers",
