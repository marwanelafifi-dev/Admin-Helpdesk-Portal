...
import { Search, Plus, Package, Truck, CheckCircle2, Clock, ChevronUp, ChevronDown, ChevronsUpDown, MessageCircle } from "lucide-react"
                  ...
                  return (
                    <React.Fragment key={shipment.id}>
                      ...
                      >
                        ...
                        <td className="py-3 px-3 overflow-hidden"><span className="text-sm text-gray-700 font-medium truncate block">{shipment.title}</span></td>
                        <td className="py-3 px-3 overflow-hidden"><span className="text-sm text-gray-700 font-medium whitespace-nowrap">{shipment.pickupDate}</span></td>
                        <td className="py-3 px-3 overflow-hidden"><span className="text-sm text-gray-700 font-medium truncate block">{shipment.trackingNumber}</span></td>
                        <td className="py-3 px-3 overflow-hidden"><span className="text-sm text-gray-700 font-medium truncate block">{shipment.poNumber}</span></td>
                        <td className="py-3 px-3 overflow-hidden"><span className="text-sm text-gray-700 font-medium truncate block">{shipment.costCenter}</span></td>
                        <td className="py-3 px-3"><span className="text-sm text-gray-700 font-medium">{shipment.carrier}</span></td>
                        ...
                        <td className="py-3 px-3"><span className="text-sm text-gray-700 font-medium whitespace-nowrap">{shipment.expectedDelivery}</span></td>
                        <td className="py-3 px-3"><span className="text-sm text-gray-700 font-medium whitespace-nowrap">{shipment.lastUpdate}</span></td>
                          ...
                          <td colSpan={11} className="py-4 px-6">
                            <div className="space-y-3 text-sm">
                              <div className="grid grid-cols-3 gap-6">
                                <div><p className="font-semibold text-gray-700">Tracking Number</p><p className="text-gray-600">{shipment.trackingNumber}</p></div>
                                <div><p className="font-semibold text-gray-700">Carrier</p><p className="text-gray-600">{shipment.carrier}</p></div>
                                <div><p className="font-semibold text-gray-700">PO Number</p><p className="text-gray-600">{shipment.poNumber}</p></div>
                                <div><p className="font-semibold text-gray-700">Cost Center</p><p className="text-gray-600">{shipment.costCenter}</p></div>
                                <div><p className="font-semibold text-gray-700">Status</p><p className="text-gray-600">{shipment.status}</p></div>
                                <div><p className="font-semibold text-gray-700">Requester</p><p className="text-gray-600">{shipment.requester}</p></div>
                              </div>
                            </div>
                          </td>
                        </tr>
