...
import { AlertCircle, ShoppingCart, Upload, X, FileText } from "lucide-react"
          ...
          <CardContent>
            <div className="space-y-3">
              ...
              <button
                ...
                className={`w-full px-6 py-8 border-2 border-dashed rounded-lg transition-all duration-200 flex flex-col items-center justify-center gap-2 ${uploadedFiles.length > 0 ? "border-green-400 bg-green-50/60 hover:bg-green-50" : "border-green-300 hover:border-green-500 hover:bg-green-50"}`}
              >
                {uploadedFiles.length > 0 ? (
                  <>
                    ...
                    <span className="text-xs text-green-500">Click to add more</span>
                  </>
                ) : (
                  <>
